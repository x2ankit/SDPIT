...
<section class="testimonials-banner" id="testimonials">
    <div class="container">
        <div class="tb-header">
            <span class="tb-badge"><i class="fas fa-trophy"></i> Success Stories</span>
            <h2 class="tb-title">What Our Students Say</h2>
            <p class="tb-sub">Hear from our achievers who made their dreams come true with SDPIT</p>
        </div>

        <div class="tb-layout">
            <!-- Left: Student Testimonials Slider -->
            <div class="student-testimonials">
                <button class="t-nav prev" type="button" aria-label="Previous testimonial" data-t-prev>
                    <i class="fas fa-chevron-left"></i>
                </button>

                <div class="t-slides" aria-live="polite">
                    <article class="t-slide is-active">
                        <div class="t-card">
                            <div class="t-card-head">
                                <img src="assets/review/10001.jpeg" alt="Priyanka Sahoo" class="t-avatar">
                                <div class="t-stars" aria-label="5 star rating">
                                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                </div>
                            </div>
                            <blockquote class="t-quote">"Excellent environment and focused study helped me prepare effectively."</blockquote>
                            <div class="t-author">
                                <div class="t-name">Priyanka Sahoo</div>
                                <div class="t-meta">AIIMS Guwahati • 2024</div>
                                <div class="t-course">📚 Medical Entrance Prep</div>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="t-slide">
                        <div class="t-card">
                            <div class="t-card-head">
                                <img src="assets/review/10002.jpeg" alt="Ankit Mishra" class="t-avatar">
                                <div class="t-stars" aria-label="5 star rating">
                                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                </div>
                            </div>
                            <blockquote class="t-quote">"Practical sessions and mentors gave me confidence to build real-world projects."</blockquote>
                            <div class="t-author">
                                <div class="t-name">Ankit Mishra</div>
                                <div class="t-meta">Graduate • 2025</div>
                                <div class="t-course">💻 Hardware Technician</div>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="t-slide">
                        <div class="t-card">
                            <div class="t-card-head">
                                <img src="assets/review/10003.jpeg" alt="Sneha Patra" class="t-avatar">
                                <div class="t-stars" aria-label="5 star rating">
                                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                </div>
                            </div>
                            <blockquote class="t-quote">"Clear curriculum and hands-on approach made learning engaging and effective."</blockquote>
                            <div class="t-author">
                                <div class="t-name">Sneha Patra</div>
                                <div class="t-meta">Student • 2025</div>
                                <div class="t-course">📖 DCA (Computer Applications)</div>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="t-slide">
                        <div class="t-card">
                            <div class="t-card-head">
                                <img src="assets/review/10004.png" alt="Rahul Nayak" class="t-avatar">
                                <div class="t-stars" aria-label="5 star rating">
                                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                </div>
                            </div>
                            <blockquote class="t-quote">"Excellent labs and regular evaluations kept me motivated throughout the course."</blockquote>
                            <div class="t-author">
                                <div class="t-name">Rahul Nayak</div>
                                <div class="t-meta">Student • 2025</div>
                                <div class="t-course">⚙️ C Programming</div>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="t-slide">
                        <div class="t-card">
                            <div class="t-card-head">
                                <img src="assets/review/10005.jpeg" alt="Meera Sahu" class="t-avatar">
                                <div class="t-stars" aria-label="5 star rating">
                                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                </div>
                            </div>
                            <blockquote class="t-quote">"Career transition into design! Portfolio reviews made all the difference."</blockquote>
                            <div class="t-author">
                                <div class="t-name">Meera Sahu</div>
                                <div class="t-meta">Graduate • 2024</div>
                                <div class="t-course">🎨 Desktop Publishing</div>
                            </div>
                        </div>
                    </article>
                </div>

                <button class="t-nav next" type="button" aria-label="Next testimonial" data-t-next>
                    <i class="fas fa-chevron-right"></i>
                </button>

                <div class="t-dots" data-t-dots aria-label="Testimonial navigation"></div>
            </div>

            <!-- Right: Parent's Testimonial Video -->
            <div class="parent-testimonial">
                <h3 class="parent-title">Parent's Testimonial</h3>
                <div class="parent-video">
                    <video autoplay muted loop playsinline class="parent-video-element">
                        <source src="assets/parent/SDPIT_Computer_Education_Video_Generated.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                    <button class="play-button" type="button" aria-label="Play video with sound"><i class="fas fa-volume-up"></i> Unmute</button>
                </div>
                <p class="parent-caption">Hear from parents about their child's journey at SDPIT</p>
            </div>
        </div>
    </div>
    <div class="tb-quote tl" aria-hidden="true"></div>
    <div class="tb-quote br" aria-hidden="true"></div>
</section>

<!-- Notice Board + Calendar Section -->
<section class="notice-calendar" id="notice-calendar">
    <div class="container">
        <div class="nc-intro">
            <span class="nc-pill"><i class="fas fa-bullhorn"></i> Happenings</span>
            <h2 class="nc-title">Notice Board & Academic Calendar</h2>
            <p class="nc-subtitle">Quick updates with a refined calendar view to keep you aligned with campus timelines.</p>
        </div>

        <div class="nc-grid">
            <div class="nc-card notice-card">
                <div class="nc-card-header">
                    <div>
                        <p class="nc-label">Notice Board</p>
                        <h3 class="nc-card-title">Latest official updates</h3>
                    </div>
                    <span class="nc-meta">Updated daily</span>
                </div>
                <ul class="notice-list">
                    <li class="notice-item">
                        <div class="notice-text">Holiday Calendar - 2026</div>
                        <div class="notice-tags"><span class="tag new">New</span><span class="tag date">Jan 08</span></div>
                    </li>
                    <li class="notice-item">
                        <div class="notice-text">Notification, Dt. 08.01.2026</div>
                        <div class="notice-tags"><span class="tag new">New</span><span class="tag date">Jan 08</span></div>
                    </li>
                    <li class="notice-item">
                        <div class="notice-text">Final Examination Event result (Dec 2025)</div>
                        <div class="notice-tags"><span class="tag">Result</span><span class="tag date">Jan 05</span></div>
                    </li>
                    <li class="notice-item">
                        <div class="notice-text">Notification, Dt. 28.12.2025</div>
                        <div class="notice-tags"><span class="tag">Notice</span><span class="tag date">Dec 28</span></div>
                    </li>
                    <li class="notice-item">
                        <div class="notice-text">Admission update: Tally Prime course</div>
                        <div class="notice-tags"><span class="tag">Admission</span><span class="tag date">Dec 26</span></div>
                    </li>
                </ul>
                <div class="nc-footer">
                    <a href="#" class="nc-link">View all notices</a>
                </div>
            </div>

            <div class="nc-card calendar-card" data-luxury-calendar>
                <div class="calendar-header">
                    <button class="cal-nav" type="button" aria-label="Previous month" data-cal-prev>
                        <i class="fas fa-chevron-left"></i>
                    </button>
                    <div class="calendar-month" data-cal-month>January 2026</div>
                    <button class="cal-nav" type="button" aria-label="Next month" data-cal-next>
                        <i class="fas fa-chevron-right"></i>
                    </button>
                </div>
                ...
                <div class="calendar-legend">
                    ...
                    <span class="legend-dot focus"></span> Key dates
                </div>
            </div>
        </div>
    </div>
...
<!-- Why SDPIT Section on Home Page -->
<section class="why-sdpit-home">
    <div class="container">
        <div class="why-sdpit-grid">
            <!-- Image Column -->
            <div class="why-sdpit-image-col">
                <div class="why-sdpit-image-wrapper">
                    <img src="assets/images/why-sdpit-student.png" alt="SDPIT Student" class="why-sdpit-image">
                </div>
            </div>
            
            <!-- Content Column -->
            <div class="why-sdpit-text-col">
                <h2 class="why-sdpit-heading">Why Choose SDPIT?</h2>
                <p class="why-sdpit-intro">A trusted institution with certified excellence and government recognition</p>
                ...
                <div class="certifications-list">
                    ...
                    <div class="cert-item">
                        ...
                        <div class="cert-text">
                            <h4>Trademarks Act, 1999</h4>
                            <p>Trademark No. 5289706</p>
                        </div>
                    </div>
                    ...
                    <div class="cert-item">
                        ...
                        <div class="cert-text">
                            <h4>Central Vigilance Commission</h4>
                            <p>Certified</p>
                        </div>
                    </div>
                    ...
                    <div class="cert-item">
                        ...
                        <div class="cert-text">
                            ...
                            <p>E17K61-0045055581314</p>
                        </div>
                    </div>
                </div>
                
                <div class="why-sdpit-cta">
                    <a href="why-sdpit.php" class="btn-learn-more">Learn More About Us</a>
                </div>
            </div>
        </div>
    </div>
